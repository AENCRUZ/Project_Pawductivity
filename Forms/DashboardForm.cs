...
public class DashboardForm : Form
{
    ...
    public DashboardForm(GameManager gm)
    {
        ...
        // ── Save on exit ─────────────────────────────────────────────
        // Fires when the user closes the window (X button or Alt+F4).
        // State is saved to %AppData%\Pawductivity\{username}.json
        // BEFORE Application.Exit() is called, so nothing is lost.
        FormClosed += (s, e) =>
        {
